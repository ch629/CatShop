...
@JsonAutoDetect
public class OrderUpdate implements Update { //TODO: Needs to contain data about the Update, may need different ones, for example OrderDeleteUpdate, as this only needs the OrderID to be sent
    ...
    public UpdateType getType() {
        return UpdateType.ORDER_UPDATE;
    }
}
