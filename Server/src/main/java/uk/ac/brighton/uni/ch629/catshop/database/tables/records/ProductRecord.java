...
public class ProductRecord extends UpdatableRecordImpl<ProductRecord> implements Record5<Integer, String, String, Integer, Double> {
    private static final long serialVersionUID = -136444487;
     ...
     */
    public ProductRecord(Integer productNumber, String description, String imageName, Integer stock, Double price) {
        super(Product.PRODUCT);
    ...
    /**
     * Getter for <code>catshop.product.ProductPrice</code>.
     */
    ...
    /**
     * Setter for <code>catshop.product.ProductPrice</code>.
     */
    public ProductRecord setProductPrice(Double value) {
        setValue(4, value);
        return this;
    }

    public ProductRecord setProductPrice(double value) {
        return setProductPrice(new Double(value));
    }

    public double getProductPriceDouble() {
        return getProductPrice().doubleValue();
    }
     ...
     */
    @Override
    public ProductRecord values(Integer value1, String value2, String value3, Integer value4, Double value5) {
        return this;
    }
}
